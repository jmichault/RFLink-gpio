...
uint8_t portInputs[10];

#define portInputRegister(P) &portInputs[P]



struct RawSignalStruct RawSignal={0,0,0,0,0,0L};
...
boolean FetchSignal(byte DataPin, boolean StateSignal) {
   //FIXME uint8_t Fbit = digitalPinToBitMask(DataPin);
   //FIXME uint8_t Fport = digitalPinToPort(DataPin);
